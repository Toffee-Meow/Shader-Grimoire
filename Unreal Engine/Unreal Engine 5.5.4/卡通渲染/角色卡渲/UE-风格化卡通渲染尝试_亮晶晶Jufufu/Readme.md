...
### 内容
&emsp;&emsp;超可爱橘福福😽角色风格化 **NPR** 卡通渲染创作✨

&emsp;&emsp;基于UE5 **默认渲染管线** 搭建 **非真实感（NPR）** 渲染方案，融合 **材质蓝图** 与 **HLSL** 代码完成Shader开发；

&emsp;&emsp;通过卡通材质编写 + 后期处理优化，打造“亮晶晶”的三渲二视觉效果。

> 最终渲染画面：卡通Shader/材质 + 后期处理
...
- 材质蓝图：
  ...
  - 卡通光照：半Lambert、阈值采样
  - 阴影：AO阴影、SDF阴影、刘海阴影（正+侧面）、屏幕空间阴影
  - 高光：MatCap、Specular、菲涅尔边缘光
  - PBR属性：Normal贴图
  - 动漫细节：眼透
  - 描边：法线外扩描边、摄像机距离限制
    - M_ToonMaster_55Styl.uasset：卡渲主材质
